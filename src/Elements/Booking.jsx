...
export default function Booking() {
  ...
  // Set minimum selectable date to 24 hours from now
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Booking confirmed! You have received an email acknowledging your request. We will verify your payment ID, and if confirmed, you will receive a final confirmation email within 24 hours.');
  ...
  return (
    <div className="booking-container">
      ...
      {/* Booking Form (Appears Dynamically) */}
      {formVisible && selectedSession && (
        <div className="bookingcomming">
          <div className="booking-form slide-down">
            ...
            <form onSubmit={(e)=>{
              ...
              <DatePicker
                ...
                showTimeSelect
                minDate={minDate} // Ensures at least 24h later
...
{payment&& (
        <div className="bookingcomming">
          ...
          {
            PaymentCross?<>
            <button className="close-btn" onClick={() => setPayment(false)}>✖</button>
            <br /><br />
            </>:<></>
          }
